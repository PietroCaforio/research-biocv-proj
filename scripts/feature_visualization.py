...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Visualize extracted features using dimensionality reduction"
    )
    parser.add_argument(
        "--features_dir",
        type=str,
...
def plot_reduced_features(
    reduced_features, labels, method, layer_name, output_path, explained_variance=None
):
...
def visualize_features(features_dict, labels, args):
    ...
    for layer_name in target_layers:
        ...
        plot_reduced_features(
            pca_features, labels, "PCA", layer_name, pca_output_path, explained_variance
        )
        ...
        plot_reduced_features(
            tsne_features, labels, "t-SNE", layer_name, tsne_output_path
        )
