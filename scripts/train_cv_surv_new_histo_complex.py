...
from models.dpe.main_model_nobackbone_surv_new_histo_complex import madpe_nobackbone  # noqa: E402
from training.trainer_from_features_survival import SurvivalTrainer   # noqa: E402
...
def main():
    ...
    for fold in range(5):
        ...
        shutil.copy(
            args.config, fold_dir / f"config_fold_{fold}.json"
        )
    ...
    if results["fold_results"]: 
        ...
        for metric_name in metric_names:
            metric_values = [fold_results["best_metrics"][metric_name] for fold_results in results["fold_results"]]
