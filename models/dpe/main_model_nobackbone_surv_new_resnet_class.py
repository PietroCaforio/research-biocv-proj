...
class DynamicPositionalEmbedding(nn.Module):
    def __init__(self, in_channels, out_channels, topk_pos= 8, topk_neg= 16):
        super().__init__()
...
class MADPENetNoBackbonesSurv(nn.Module):  # ModalityAwareDPENet da decidere nome
    ...
    def __init__(
        ...
        self.fusion = fusion_layer(d_model=self.token_dim,dim_hider=self.dim_hider,nhead=8, dropout=0.25)
