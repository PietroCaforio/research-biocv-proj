...
class MADPENetNoBackbones(nn.Module):  # ModalityAwareDPENet da decidere nome
    ...
    def __init__(
        ...
        self.classification_net = nn.Sequential(
            ...
            nn.Linear(self.token_dim, num_classes)  # Output layer
        )
    ...
    def forward(self, rad_feature, histo_feature, modality_flag=None, output_layers=["classification"]):
        """Forward pass:
        ...
        out = self.classification_net(out)
